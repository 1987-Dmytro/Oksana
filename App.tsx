...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen bg-slate-950 overflow-hidden relative flex flex-col font-sans select-none">
      {/* Toast Notification */}
      <AnimatePresence>
        {showCopyToast && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-24 left-1/2 -translate-x-1/2 z-[100] bg-emerald-500 text-white px-6 py-3 rounded-full shadow-2xl flex items-center gap-3 font-bold"
          >
      ...
      <header className="fixed top-0 w-full z-50 p-6 md:p-10 flex justify-between items-center pointer-events-none">
        <div className="flex items-center gap-3">
          ...
          <div className="pointer-events-auto">
            <h1 className="text-xl font-bold font-header tracking-tighter">B.L.S. TRANS.LOGISTIK</h1>
            <p className="text-[10px] text-slate-400 uppercase tracking-widest font-semibold">Logistics & Insurance</p>
          </div>
        </div>
      ...
      return (
        <div className="grid md:grid-cols-2 gap-12 items-center w-full">
          <div className="space-y-8">
            ...
            <h2 className="text-6xl md:text-8xl font-black font-header leading-[1.1]">
              Захист <br /> 
            ...
            <div className="flex gap-4">
              <button className="bg-orange-500 px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-orange-500/30 transition-all active:scale-95">Отримати аудит</button>
              <button className="border border-slate-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-slate-900 transition-all active:scale-95">Наші рішення</button>
            </div>
          </div>
          <div className="relative hidden md:block">
            ...
            <img 
              src={slide.image} 
              className="w-full h-[500px] object-cover rounded-[40px] shadow-2xl border border-white/5" 
              alt="Truck"
            />
          </div>
        </div>
      ...
      return (
        <div className="w-full space-y-12">
          <div className="max-w-3xl">
            <h2 className="text-5xl font-black font-header mb-4">{slide.title}</h2>
            <p className="text-slate-400 text-lg">Комплексний підхід до кожного вантажу та маршруту.</p>
          </div>
      ...
      return (
        <div className="w-full space-y-16">
           <div className="text-center">
              <h2 className="text-6xl font-black font-header mb-4">{slide.title}</h2>
              <p className="text-slate-400 text-xl">Ми цінуємо ваш час. Швидкість та прозорість — наші пріоритети.</p>
           </div>
